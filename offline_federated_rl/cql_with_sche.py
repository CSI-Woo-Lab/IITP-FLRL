...
class CQL(AlgoBase):
    ...
    def __init__(
        ...
        *,
        ...
        actor_encoder_factory: EncoderArg = "FeatureExtract",
        critic_encoder_factory: EncoderArg = "FeatureExtract",
    ...
    def _create_impl(
        ...
        '''
        self.actor_scheduler = torch.optim.lr_scheduler.CyclicLR(self._impl._actor_optim, base_lr=0.0001, max_lr=0.0025, step_size_up=5, cycle_momentum=False)
        ...
        self.temp_scheduler = torch.optim.lr_scheduler.CyclicLR(self._impl._temp_optim, base_lr=0.0001, max_lr=0.0025, step_size_up=5, cycle_momentum=False)
