...
LANDINGPOINT_X = 8 # 0~11 / 2, 5, 8 / default 5
LANDINGPOINT_Y = 4 # 0~16 ( 2~8 ) / 2, 4, 8 / default 4
...
class LunarLander(gym.Env, EzPickle):
    ...
    def reset(self):
        ...
        self.helipad_x1 = chunk_x[LANDINGPOINT_X-1]
        self.helipad_x2 = chunk_x[LANDINGPOINT_X+1]
        self.helipad_y = H/16 * LANDINGPOINT_Y
        height[LANDINGPOINT_X-2] = self.helipad_y
        height[LANDINGPOINT_X-1] = self.helipad_y
        height[LANDINGPOINT_X+0] = self.helipad_y
        height[LANDINGPOINT_X+1] = self.helipad_y
        height[LANDINGPOINT_X+2] = self.helipad_y
    ...
    def step(self, action):
        ...
        # custom helipad
        GOALPOSITION_X = VIEWPORT_W/SCALE/12 * LANDINGPOINT_X
        state = [
            (pos.x - GOALPOSITION_X) / (VIEWPORT_W/SCALE/2), 
        ...
        #end point ( edge )
        if self.game_over or state[0] >= (12-LANDINGPOINT_X)/6 or state[0] < (0-LANDINGPOINT_X)/6:
            done = True
            reward = -100
