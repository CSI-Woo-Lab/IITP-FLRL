...
main_dir_name = "forl_logs/model_20220119165656_bcq_Navi-Acc-Lidar-Obs-Task0_easy-v0_50_round_models"

algo = "BCQ-FL"
n_client = 5
n_epoch = 5
csv_file = open("forl_bcq_num_client_5_epoch_5_round_50.csv", "w")
